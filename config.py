...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/GOVIND-BOTS/Saste-nashe")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "master")

GIT_TOKEN = getenv("GIT_TOKEN", None)

SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/itz_Cindrella_Bits")
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://govind-bots.github.io/My--about/")
...
START_IMG_URL = getenv("START_IMG_URL", "https://telegra.ph/file/f00cc4b4b40d874d037d8.jpg")

PING_IMG_URL = getenv(
    "PING_IMG_URL",
    "https://telegra.ph/file/d6205f4f70685473738e7.jpg",
)
